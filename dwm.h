...
static void updatexkbprop(Client *c);
...
static void UNUSED quit(const Arg *arg);
...
static void UNUSED attachabove(Client *c);
static void UNUSED attachbelow(Client *c);
static void UNUSED attachtop(Client *c);
static void UNUSED attachbottom(Client *c);
...
static void updatefullscreenprop(Client *c);
...
static int hasatomprop(Window w, Atom prop, Atom test);
static void extendatomprop(Window w, Atom prop, Atom value);
static void shrinkatomprop(Window w, Atom prop, Atom value);
static int gettextprop(Window w, Atom atom, char *text, unsigned int size);
static int getxembedinfoprop(Window w, unsigned int *version, unsigned int *flags);
static long getwinstate(Window w);
static int gettransientfor(Window w, Client **transfor);
static int getrootptr(int *x, int *y);
static Window getpointerwin(void);
