...
static void drwmap(Monitor *m, unsigned int w, int dest_x);
static unsigned int drwgettextwidth(const char *text);
static unsigned int drwgettextwidthclamp(const char *text, unsigned int n) __attribute__((unused));
static void drwupdatesize(void);
static void drwrect(int x, int y, unsigned int w, unsigned int h, int filled, int invert);
static DrwFont *xftfontcreate(const char *fontname, FcPattern *fontpattern);
static void drwfree(void);
static void drwfreefonts(DrwFont *font);
static void xftfontfree(DrwFont *font);
static int drwtext(const char *text, int x, int y, unsigned int w, unsigned int h, unsigned int pad, int invert);
static void drwgetextents(DrwFont *font, const char *text, unsigned int len, unsigned int *w, unsigned int *h);
