...
static Window mksimplewin(void);
static void drwinit(void);
static void drwmap(Window win, int x, int y, unsigned int w, unsigned int h);
static unsigned int drwgetwidth(const char *text);
static unsigned int drwgetwidthclamp(const char *text, unsigned int n) __attribute__((unused));
static void drwupdatesize(unsigned int w, unsigned int h);
static void drwrect(int x, int y, unsigned int w, unsigned int h, int filled, int invert);
static DrwFont *xfontcreate(const char *fontname, FcPattern *fontpattern);
static void drwfree(void);
static void drwfreefonts(DrwFont *font);
static void xfontfree(DrwFont *font);
static int drwtext(int x, int y, unsigned int w, unsigned int h, unsigned int lpad, const char *text, int invert);
static void drwgetfontexts(DrwFont *font, const char *text, unsigned int len, unsigned int *w, unsigned int *h);
